<section>
    ...
    <form method="post" action="{{ route('password.update') }}"  >
        ...
        <div class="mb-3"  >
            <label class="text-white"  for="update_password_current_password" >Current Password</label>
        ...
        <div class="mb-3"  >
            <label class="text-white"  for="update_password_password" >New Password</label>
        ...
        <div class="mb-3"  >
            <label class="text-white" for="update_password_password_confirmation" >Confirm Password</label>
